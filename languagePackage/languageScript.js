...
if (window.location.href.includes('/homepage.html')) {
    document.querySelector('.footerHeader').innerHTML = '<img src="images/abdullahSögütImages/abdullahSögütBackgroundImage1.jpg" class="abdullahfooterIcon">Your Future, my Expertise.';
    document.querySelector('.footerHome').innerHTML = '<a href="homepage.html">Home</a>';
    document.querySelector('.footerAboutMe').innerHTML = '<a href="pages/aboutMePage/aboutMe.html">About Me</a>';
    document.querySelector('.footerContact').innerHTML = '<a href="pages/contactPage/contact.html">Contact</a>';
  } else if (window.location.href.includes('/aboutMe.html') || window.location.href.includes('/contact.html')) {
  document.querySelector('.footerHeader').innerHTML = '<img src="../../images/abdullahSögütImages/abdullahSögütBackgroundImage1.jpg" class="abdullahfooterIcon">Your Future, my Expertise.';
  document.querySelector('.footerHome').innerHTML = '<a href="../../homepage.html">Home</a>';
  if (window.location.href.includes('/aboutMe.html')) {
    ...
    document.querySelector('.footerContact').innerHTML = '<a href="../contactPage/contact.html">Contact</a>';
  } else if (window.location.href.includes('/contact.html')) {
    document.querySelector('.footerAboutMe').innerHTML = '<a href="../aboutMePage/aboutMe.html">About Me</a>';
    ...
    document.querySelector('.aboutMePageIntroductoryText6').innerHTML = 'Check Out My GitHub <img src="images/degrees/gitHubIcon.svg" class="gitHubIcon">';
...
if (window.location.href.includes('/homepage.html')) {
  document.querySelector('.footerHeader').innerHTML = '<img src="images/abdullahSögütImages/abdullahSögütBackgroundImage1.jpg" class="abdullahfooterIcon">Ihre Zukunft, meine Expertise.';
} else if (window.location.href.includes('/aboutMe.html') || window.location.href.includes('/contact.html')) {
document.querySelector('.footerHeader').innerHTML = '<img src="../../images/abdullahSögütImages/abdullahSögütBackgroundImage1.jpg" class="abdullahfooterIcon">Ihre Zukunft, meine Expertise.';
}
    ...
    if (window.location.href.includes('/aboutMe.html') || window.location.href.includes('/contact.html')) {
      ...
      document.querySelector('.footerHeader').innerHTML = '<img src="../../images/abdullahSögütImages/abdullahSögütBackgroundImage1.jpg" class="abdullahfooterIcon">Ihre Zukunft, meine Expertise.';
          if (window.location.href.includes('/aboutMe.html'))  {
            ...
            document.querySelector('.footerContact').innerHTML = '<a href="../contactPage/contact.html">Kontakt</a>';
        } else if (window.location.href.includes('/contact.html')) {
          document.querySelector('.footerAboutMe').innerHTML = '<a href="../aboutMePage/aboutMe.html">Über Mich</a>';
          document.querySelector('.footerContact').innerHTML = '<a href="contact.html">Kontakt</a>';
        }
  } else if (window.location.href.includes('/homepage.html')) {
    document.querySelector('.footerHeader').innerHTML = '<img src="images/abdullahSögütImages/abdullahSögütBackgroundImage1.jpg" class="abdullahfooterIcon">Ihre Zukunft, meine Expertise.';
    document.querySelector('.footerHome').innerHTML = '<a href="homepage.html">Startseite</a>';
    document.querySelector('.footerAboutMe').innerHTML = '<a href="pages/aboutMePage/aboutMe.html">Über Mich</a>';
    document.querySelector('.footerContact').innerHTML = '<a href="pages/contactPage/contact.html">Kontakt</a>';
  }
...
if (window.location.href.includes('/homepage.html')) {
    ...
    document.querySelector('.aboutMePageIntroductoryText6').innerHTML = 'Besuche mein GitHub <img src="images/degrees/gitHubIcon.svg" class="gitHubIcon">';
...
function projectListSelector(className) {
  ...
  if (!(window.location.hash === '#projectImageSlider1Header')) {
    projectPath = `pages/projectPages/mp3/mp3Index.html`;
  }
  ...
  element.addEventListener('click', function() {
    new Promise(resolve => {
      projectPath = `pages/projectPages/${nameOfClass}/${nameOfClass}Index.html`;
      ...
      projectImageSlider2Images1.src = `images/projects/${nameOfClass}/${nameOfClass}Picture.png`;
      projectImageSlider1Header.textContent = `${projectHeader}`;
      projectImageSlider2ImagesProjectDescription.textContent = `${projectText}`;
      projectImageSlider2Images3.src = `images/projects/${nameOfClass}/${nameOfClass}Picture1.png`;
      return new Promise(resolve => {
        setTimeout(() => {
          resolve();
        }, 500);
...
if(window.innerWidth > 450 && window.innerWidth < 1150) {
  ...
  if (window.location.href.includes('/aboutMe.html') || window.location.href.includes('/contact.html')) {
    ...
    ocument.querySelector('.footerHeader').innerHTML = '<img src="images/abdullahSögütImages/abdullahSögütBackgroundImage1.jpg" class="abdullahfooterIcon">Your Future, my Expertise.';
    document.querySelector('.footerHome').innerHTML = '<a href="homepage.html">Home</a>';
    document.querySelector('.footerAboutMe').innerHTML = '<a href="pages/aboutMePage/aboutMe.html">About Me</a>';
    document.querySelector('.footerContact').innerHTML = '<a href="pages/contactPage/contact.html">Contact</a>';
}
