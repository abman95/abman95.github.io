...
languageEnglish.addEventListener('click', function () {
    ...
    document.querySelector('.aboutMePageIntroductoryText4').textContent = "When I reached the limits of WordPress Elementor, my curiosity for programming was ignited. With enthusiasm, I delved deep into the world of HTML, CSS, JavaScript, and PHP to implement additional functionalities and expand my technical skills.";
...
if (window.location.href.includes('/homepage.html')) {
    ...
    document.querySelector('.aboutMePageIntroductoryText4').textContent = "Als ich die Grenzen von WordPress Elementor erreichte, wurde meine Neugier auf das Programmieren entfacht. Mit Begeisterung tauchte ich tief in die Welt von HTML, CSS, JavaScript und PHP ein, um zusätzliche Funktionalitäten zu implementieren und meine technischen Fähigkeiten zu erweitern.";
